...
<html>
<head>
	<title>Book Published Data</title>
...
<body>
	...
	<div class="select_field" align="center">
		<form action="book_published_data_fetch.php" method="POST">
	...
	<center>
		<table class="list">
			...
			<?php
						...
						echo "<td><center><a class='btn' href='/College-Staff/book_published_data_fetch.php?name=".$row["EMPLOYEE_ID"]."'>&nbsp &nbsp &nbspView &nbsp&nbsp&nbsp</a></center></td>";
						echo "</tr>";
						$slno++;
					}
				}
