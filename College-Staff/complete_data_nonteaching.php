...
<body>
	...
	<div class="select_field" align="center">
		<form action="complete_data_nonteaching_fetch.php" method="POST">
	...
	<center>
		<table class="list">
			...
			<?php
						...
						echo "<td><center><a class='btn' href='complete_data_nonteaching_fetch.php?name=".$row["EMPLOYEE_ID"]."'>&nbsp &nbsp &nbspView &nbsp&nbsp&nbsp</a></center></td>";
						echo "</tr>";
						$slno++;
					}
				}
