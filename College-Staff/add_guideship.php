...
<body>
	...
	<div class="select_field" align="center">
		<form action="add_guideship_details.php" method="POST">
		<label class="font_bold"> Employee Name :</label>
			...
			<input  class="btn" type="submit" value="Add Data">
		</form>
	</div>
	<style type="text/css">
		.list{
	...
	<center>
		<table class="list">
			...
			<?php
						...
						echo "<td><center><a class='btn' href='/College-Staff/paper_data_fetch.php?name=".$row["EMPLOYEE_ID"]."'>&nbsp &nbsp &nbspView &nbsp&nbsp&nbsp</a></center></td>";
						echo "</tr>";
						$slno++;
					}
				}
