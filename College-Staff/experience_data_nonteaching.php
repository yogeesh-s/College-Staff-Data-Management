...
<body>
	...
	<div class="select_field" align="center">
		<form action="experience_data_nonteaching_fetch.php" method="POST">
			<table>
				<tr>
	...
	<style type="text/css">
		...
		<?php
			...
			$stop = $date->format('Y-m-d');
				$sql = "SELECT * FROM PERSONAL_INFORMATION_DETAILS WHERE STAFF_TYPE = 'NONTEACHING' AND DATE_OF_ENTRY_SERVICE BETWEEN '1900-01-01' AND '$stop'";
