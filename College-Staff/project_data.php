...
<body>
	...
	<div class="select_field" align="center">
		<form action="project_data_fetch.php" method="POST">
	...
	<center>
		<table class="list">
			...
			<?php
						...
						echo "<td><center><a class='btn' href='/College-Staff/project_data_fetch.php?name=".$row["EMPLOYEE_ID"]."'>&nbsp &nbsp &nbspView &nbsp&nbsp&nbsp</a></center></td>";
						echo "</tr>";
						$slno++;
					}
				}
