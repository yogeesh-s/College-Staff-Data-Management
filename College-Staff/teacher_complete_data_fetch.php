		...
		<?php
			...
			if($eid!="---Select---")
			{
				...
				$sql1 = "SELECT * FROM QUALIFICATION_DETAILS WHERE EMPLOYEE_ID = '$eid'";
					...
					{
						echo "<table class=tab2><tr><td colspan='6'><h2>Project Minor / Major Details :</h2></td></tr>";
						echo "<tr>
								<th>TYPE</th>
								<th>NAME</th>
								<th>SPONSERER</th>
					...
					{
						echo "<table class=tab2><tr><td colspan='7'><h2>Project Major / Minor Details :</h2></td></tr>";
						echo "<tr><td colspan='7' align='center'>No Data Found</td></tr></table>";
					}
